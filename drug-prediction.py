...
GREETING = ['Hello! My name is P8-bot. I will try my best to provide you information related to Disease Drug !']
...
def matchingSentence(inp):
	...
	c = conn.cursor()
	f = open('C:/Users/Shiva/Desktop/chatbot/database/questions.txt')
	match = "";
	max_score=0;
