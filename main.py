...
#conn = sqlite3.connect('C:/Users/Haneesh.s/Desktop/chatbot/seminar2_progress/shrya/db/sqlite/db/pythonsqlite.db')
...
def matchingSentence(inp):
	...
	c = conn.cursor()
	f = open('C:/Users/Haneesh.s/Desktop/chatbot/database/questions.txt')
	match = "";
	max_score=0;
